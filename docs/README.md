...
This folder consolidates project documentation that was previously scattered across the repository. Key areas:

- Architecture: Design and system overviews
- Migrations: Upgrade notes and changes over time
- Integration: AI and external service setup
- Brand: Identity and implementation reports
- Guides: Team-facing guidance and conventions
